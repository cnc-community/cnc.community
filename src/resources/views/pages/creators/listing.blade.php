...
<section class="stream-listings">
    <div class="main-content">
        <div class="twitch-games-navbar">
            ...
            <a href="?gameName=command-and-conquer-3-kanes-wrath" id="game-id-18733 {{ $gameName == "command-and-conquer-3-kanes-wrath" ? " active": ""}}" class="twitch-game-link">Command & Conquer 3: Kane's Wrath <span class="count">0</span></a>
