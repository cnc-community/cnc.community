    ...
    <section class="section prizes">
        <div class="main-content text-center">
            ...
            <div class="about-prizes">
                ...
                <p>
                    EA Play Pro members can play the deluxe editions of every new Electronic Arts title -- with all the added extras including in-game rewards,
                    Season Passes, and premium player content that lets you stand out from the competition – as soon as they drop. Plus, members have instant access
                    to The Play List, a library of our fan-favorite series and best loved titles.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="main-content text-center">
            <div class="page-content">
                ...
                <p>
                    ...
                    violating any EAUA Remastered terms and conditions as <a href="https://store.steampowered.com//eula/1213210_eula_0" target="_blank">listed
                        here</a>,
                ...
                <p>
                    ...
                    Prizes will be awarded to Steam and Origin Players. Players who have won, will have their Steam or Origin username listed on the C&C community
                    website as a winner.

                    The winners Steam or Origin account will then be added as a friend by a member of the C&C Community website team. If for whatever reason, the
                    winners profile does not allow this, the players will not be eligible for a prize.

                    Upon sending a request and accepting, they will be asked to confirm they are able to accept the prize as the account holder and are of age in
                    accordance to the Command & Conquer:tm: Remastered Collection EULA terms and conditions.
                </p>

                <p>
                    Players who have won a prize, will have 14 days from the point of initially being contacted to accept the friend request and claim their prize.
                    If after this period no contact is made, the player will lose their prize.
                </p>
                ...
                <p>
                    In the extremely rare occasion prizes are withdrawn from the C&C Community teams possession, we will not be able to honor the delivery of prizes
                    to winners.
                </p>

                <p>
                    * THIS OFFER IS BEING ISSUED TO YOU FOR PROMOTIONAL PURPOSES ONLY AND DOES NOT HAVE A CASH VALUE. SINGLE-USE CODE EXPIRES ON [09/24/2021]. CODE
                    VALID FOR ONE MONTH OF EA PLAY PRO ("PRODUCT") FROM THE ORIGIN STORE (origin.com). MAY NOT BE COMBINED WITH ANY OTHER PROMOTIONAL OR DISCOUNT
                    OFFER, UNLESS EXPRESSLY AUTHORIZED BY EA; MAY NOT BE COMBINED WITH ANY PREPAID CARD REDEEMABLE FOR THE APPLICABLE CONTENT. LIMIT ONE CODE PER
                    PERSON. OFFER MAY NOT BE SUBSTITUTED, EXCHANGED, SOLD OR REDEEMED FOR CASH OR OTHER GOODS OR SERVICES. VOID WHERE PROHIBITED, TAXED OR
                    RESTRICTED BY LAW.
                </p>
                <p>
                    * THIS OFFER IS BEING ISSUED TO YOU FOR PROMOTIONAL PURPOSES ONLY AND DOES NOT HAVE A CASH VALUE. SINGLE-USE CODE EXPIRES ON [09/24/2021]. CODE
                    VALID FOR TWELVE MONTHS OF EA PLAY PRO ("PRODUCT") FROM THE ORIGIN STORE (origin.com). MAY NOT BE COMBINED WITH ANY OTHER PROMOTIONAL OR
                    DISCOUNT OFFER, UNLESS EXPRESSLY AUTHORIZED BY EA; MAY NOT BE COMBINED WITH ANY PREPAID CARD REDEEMABLE FOR THE APPLICABLE CONTENT. LIMIT ONE
                    CODE PER PERSON. OFFER MAY NOT BE SUBSTITUTED, EXCHANGED, SOLD OR REDEEMED FOR CASH OR OTHER GOODS OR SERVICES. VOID WHERE PROHIBITED, TAXED OR
                    RESTRICTED BY LAW.
                </p>
            </div>
        </div>
