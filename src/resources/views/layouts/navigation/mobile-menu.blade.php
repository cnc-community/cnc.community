<div class="navbar-items">
    ...
    <div class="category">
        ...
        <a href="/command-and-conquer-remastered#mods" title="C&C Mods" class="nav-link">Mod Workshop</a>
        <a href="/command-and-conquer-4" title="Command & Conquer 4" class="nav-link">Tournaments</a>
    </div>
