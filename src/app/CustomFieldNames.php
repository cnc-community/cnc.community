...
{
    public const HOW_TO_PLAY_STEPS = "how_to_play_steps";
    public const HOW_TO_PLAY_SHORT_DESCRIPTION = "how_to_play_short_description";
    public const HERO_DESCRIPTION = "hero_description";
